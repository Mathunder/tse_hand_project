    ...
    QFuture<void> future = QtConcurrent::run([this]() {
        *window >> frame;
        ...
        for (int n=0; n<npairs; n++) {
            ...
            // Checks if the difference in Y coordinates is positive or negative (X for the thumb)
            // The points used for the operation are the one connected to the base of the last phalanx
            // and the tip of the last phalanx
            switch(n) {
            case 3 :
